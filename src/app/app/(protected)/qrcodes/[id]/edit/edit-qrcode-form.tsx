...
export function EditQrCodeForm({ qrCode, zones }: EditQrCodeFormProps) {
  const router = useRouter();
  const [loading, setLoading] = useState(false);
  const [selectedZoneId, setSelectedZoneId] = useState<string | null>(qrCode.zoneId);
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Modifier le QR code</h1>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <Select value={selectedZoneId || ''} onValueChange={(v) => setSelectedZoneId(v || null)}>
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Input
                id="tableNumber"
                name="tableNumber"
                defaultValue={qrCode.tableNumber || ''}
